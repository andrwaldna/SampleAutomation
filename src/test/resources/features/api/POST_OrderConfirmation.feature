...
Feature: Order Confirmation
  ...
  Scenario Outline: TS-<SceneID>-<Description>
    ...
    When I send a POST request for order confirmation
      | orderId   | userId   | email   | name   | orderDate   | totalAmount   | currency   | productId   | productName   | quantity   | price   | productId   | productName   | quantity   | price   | line1   | line2   | city   | state   | postalCode   | country   | sendEmail   |
      | <orderId> | <userId> | <email> | <name> | <orderDate> | <totalAmount> | <currency> | <productId> | <productName> | <quantity> | <price> | <productId> | <productName> | <quantity> | <price> | <line1> | <line2> | <city> | <state> | <postalCode> | <country> | <sendEmail> |
    ...
    Examples:
      ...
      | 001     | User send POST request to add pet details | orderId1234 | test userId | test email | test name | 2025-06-26T08:00:00Z | 150         | USD      | productId1234 | test productName | 3        | 50    | test line1 | test line2 | test city | test state | 1234       | test country | Yes       | 200                |
